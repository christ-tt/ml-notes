i**The Roadmap:** We will start by establishing the Memory Bandwidth Bottleneck (Section 1), move to the necessity of Global Pipelining (Section 2), and finally prove why Local Pipelining fails to solve the P2P bottleneck on edge devices (Section 3).
...
# 2. Pipeline Parallel - Why we Choose PP over TP without NVLink

# 3. Working with Pipeline - Slowest Stage Determines System Throughtput
...
### **3.2 Two stages: one fast, one slow**
...
### 3.4 Number of Stages, Micro-Batches, and Bubbles
